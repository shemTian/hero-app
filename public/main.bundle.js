...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__hero_detail_component__ = __webpack_require__("../../../../../src/app/hero-detail.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__heroes_component__ = __webpack_require__("../../../../../src/app/heroes.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5_angular_in_memory_web_api__["a" /* HttpClientInMemoryWebApiModule */].forFeature(__WEBPACK_IMPORTED_MODULE_6__in_memory_data_service__["a" /* InMemoryDataService */])
            ],
            declarations: [
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.heroService.getHeroes().then(function (heroes) { console.log(heroes); _this.heroes = heroes.slice(1, 5); });
    };
...
var HeroService = (function () {
    function HeroService(httpClient) {
    ...
    HeroService.prototype.getHeroes = function () {
        ...
        return this.httpClient.get(this.heroesUrl).toPromise().then(function (heroes) { console.log(heroes); return heroes.data; }).catch(this.handleError);
...
var HeroesComponent = (function () {
    ...
    HeroesComponent.prototype.onSelectHero = function (hero) {
    ...
    HeroesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__hero_service__["a" /* HeroService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */]])
    ], HeroesComponent);
